...
for(var i = 0; i < keys.length; i++) {
	keys[i].onclick = function(e) {
		...
		//input is now the screen
		var input = document.querySelector('.screen');
		//create inputVal to contain everything passed into the screen
		var inputVal = input.innerHTML;
		//btnVal is every value passed in except C, =, and multiply
		...
		// If eval key is pressed, calculate and display the result
			...
			// Replace all instances of x with * respectively. This can be done easily using regex 
